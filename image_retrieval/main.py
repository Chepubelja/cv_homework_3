...
if __name__ == '__main__':
    ...
    for query in QUERIES:
        ...
        distances = [(img_name, l2_distance(query_hists, hists)) for img_name, hists in all_hists.items() if img_name != query]
    ...
    - 'ukbench01562' - Only third match (from first 10) is correct.
